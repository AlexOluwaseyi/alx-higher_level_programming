#!/usr/bin/python3
"""9-rectangle, built for Holberton Python project 0x08 task 1.
"""
...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Compares two rectangles and returns the larger.
    ...
    def square(cls, size=0):
        """A square is a rectangle. Assigns same size to width & height
